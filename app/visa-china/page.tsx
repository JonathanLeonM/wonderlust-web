    ...
    <div style={{ minHeight: "100vh", padding: "clamp(20px,5vw,56px) 16px", display: "flex", justifyContent: "center", background: colors.bg, color: colors.ink, fontFamily: "'Karla',system-ui,sans-serif" }}>
      <div style={{ width: "100%", maxWidth: 760 }}>
        ...
        <div style={{ background: colors.card, borderRadius: "2px 30px 2px 30px", padding: "clamp(22px,4vw,38px)", border: "1px solid rgba(58,44,34,.16)", boxShadow: "0 1px 0 rgba(58,44,34,.05)" }}>
          ...
          {step === 2 && (
            <>
              <div style={{ fontFamily: "'Marcellus',serif", fontSize: 19, color: colors.teal, marginBottom: 4 }}>Contacto de emergencia</div>
              <div style={{ fontSize: 13, color: colors.muted, marginBottom: 14 }}>Una persona <strong style={{ color: colors.teal }}>en Colombia</strong> (familiar o alguien de confianza) a quien podamos llamar si ocurre algo durante tu viaje. <strong style={{ color: colors.teal }}>No</strong> tiene que ser un contacto en China.</div>
              <div style={{ display: "flex", gap: 10, alignItems: "flex-start", background: "#f7f2ea", borderLeft: "3px solid #c4703f", padding: "12px 14px", borderRadius: 6, marginBottom: 22 }}>
                <span style={{ fontSize: 15, lineHeight: 1.2 }}>ℹ️</span>
                <span style={{ fontSize: 12.5, color: "#6b5b4a", lineHeight: 1.5 }}>Puede ser tu mamá, papá, pareja, hermano/a o un amigo cercano. Solo necesitamos su nombre, cómo se relaciona contigo, su teléfono y su correo.</span>
              </div>
